...
const Footer = () => {
  ...
  return (
    <footer className='flex flex-col sm:flex-row justify-center gap-12 bg-gray-600 text-dirty-white min-h-[40vh] w-full py-24 px-4 overflow-hidden' >
      <div className='flex gap-8'>
        <div className='flex flex-col gap-4'>
          <div className='flex flex-col gap-2'>
            <span className='text-2xl'>Company</span>
            <Link className='font-thin hover:text-white duration-150' href='/about'>About Us</Link>
          </div>
          <div className='flex flex-col gap-2'>
            <span className='text-2xl'>Products</span>
            <Link className='font-thin hover:text-white duration-150' href='/economy'>Economic Indicators</Link>
            <Link className='font-thin hover:text-white duration-150' href='/dashboard'>Dashboard</Link>
          </div>
        </div>
        <div className='flex flex-col gap-2'>
      ...
      <div className='flex flex-col sm:w-1/3 gap-4 sm:-order-1'>
