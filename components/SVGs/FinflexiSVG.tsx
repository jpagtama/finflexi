...
const FinflexiSVG: React.FC<{introEndHandler: () => void}> = props => {

  return (
    <div className={styles.finflexi_icon}>
      <svg width="293" height="259" viewBox="0 0 293 259" fill="none" xmlns="http://www.w3.org/2000/svg" onAnimationEnd={props.introEndHandler}>
