...
const Dashboard = () => {
    ...
    if (isLoadingUserInfo) return <div className='flex justify-center min-h-screen w-full pt-36'><Loading /></div>

    if (!isLoadingUserInfo && isLoggedIn === false) {
        router.replace('/signin');
        return <div className='min-h-screen w-full pt-36'><Loading /></div>;
    }

    return (
        <div className='flex flex-col items-center min-h-screen w-full pt-36'>
